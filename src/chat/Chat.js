...
class Chat extends Component {
  ...
  componentDidMount() {
    ...
    let destUserToken = this.props.chatID.replace(
  ...
  sendMessage(e) {
    ...
    this.props.db.collection(`chat/${this.props.chatID}/messages`).add({
  ...
  setupListener() {
    ...
    this.unsub = this.props.db
      .collection(`chat/${this.props.chatID}/messages`)
          ...
          renderItem={messBody => (
            <List.Item style={{ borderBottom: "none", padding: "6px 0px" }}>
              <Message
                ...
                currUID={this.props.currentUser.uid}
                message={messBody}
              />
            </List.Item>
          )}
